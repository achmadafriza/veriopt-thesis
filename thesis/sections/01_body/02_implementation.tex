...
which utilizes Jackson's \mono{ObjectMapper}\footnote{\href{jackson-databind 2.7.0 {API}}{https://fasterxml.github.io/jackson-databind/javadoc/2.7/com/fasterxml/jackson/databind/ObjectMapper.html}}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.65\textwidth]{structurizr-1-Dynamic-001.png}
